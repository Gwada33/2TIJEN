...
- **Animations** : volontairement rares. À l'arrivée, chaque lettre de « CARIBBEAN REPRESENT » est un papier découpé tiré au hasard (forme, police, couleur, bordure, majuscule ou minuscule) : tout change en boucle puis se fixe lettre par lettre, différent à chaque visite (composant `components/Ransom.tsx`, listes de polices et de couleurs et durées en haut du fichier). Le t-shirt se retourne au survol. Tout se coupe pour les personnes qui ont activé « réduire les animations ».
