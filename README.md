...
- **Animations** : volontairement rares. À l'arrivée, les lettres de « CARIBBEAN REPRESENT » changent de police et de couleur puis se fixent une à une (composant `components/Ransom.tsx`, durées en haut du fichier) ; le t-shirt se retourne au survol. Tout se coupe pour les personnes qui ont activé « réduire les animations ».
